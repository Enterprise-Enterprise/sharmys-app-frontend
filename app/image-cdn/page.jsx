  ...
  return (
    <div className="flex flex-col gap-6 sm:gap-12">
      ...
      <section>
        ...
        <div
          className="relative mt-8 max-w-screen-lg overflow-hidden rounded-lg border-2 border-white"
      ...
      <section>
        ...
        <div className="diff mt-8 aspect-[3/2] rounded-lg border-2 border-white">
